...
<div class="wrap">
    <h1><?= Html::encode($this->title) ?></h1>
        ...
        <?= $article->text ?>
    <p>
        <?= Html::button('Create Comment', ['value'=>Url::to(['createcomment', 'article_id' => $article->id]),
            ...
            [
                ...
                'buttons'=>[
                    ...
                    'create' => function ($url, $model) {
                                if ($model->confirmation == 1)
                                {
                                    return Html::button ('<span class="glyphicon glyphicon-comment "></span>', [
                                        'value'=>$url,
